...
public enum NotifType
{
    ...
    CAMBIO_PLAN,
    /// <summary>Notificación al cliente cuando el precio de su plan actual cambia.</summary>
    CAMBIO_PRECIO,
    /// <summary>Alerta al administrador cuando el QR de pago de la empresa está próximo a vencer.</summary>
    QR_COMPANY_EXPIRA,
    /// <summary>Alerta interna al técnico asignado cuando el SLA del ticket está próximo a vencer.</summary>
    ALERTA_SLA,
    /// <summary>Notificación al cliente cuando se agenda una visita técnica en su ticket.</summary>
    VISITA_PROGRAMADA
}
