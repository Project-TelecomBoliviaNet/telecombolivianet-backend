...
public enum InvoiceType
{
    Mensualidad      = 0,
    Instalacion      = 1,
    Extraordinaria   = 2,   // US-FAC-02
    ProrrataAnterior = 3,   // días con plan anterior en cambio mid-month
    ProrrataNueva    = 4,   // días con plan nuevo en cambio mid-month
}
...
public class Invoice : Entity
{
    ...
    // Snapshot del plan al momento de generación — preserva historial si el plan cambia de nombre o precio
